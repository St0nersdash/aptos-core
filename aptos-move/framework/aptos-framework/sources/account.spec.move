spec aptos_framework::account {
    ...
    spec assert_valid_signature_and_get_auth_key(scheme: u8, public_key_bytes: vector<u8>, signature: vector<u8>, challenge: &RotationProofChallenge): vector<u8> {
        aborts_if scheme == ED25519_SCHEME && len(public_key_bytes) != ed25519::PUBLIC_KEY_NUM_BYTES;
        aborts_if scheme == ED25519_SCHEME && len(signature) != ed25519::SIGNATURE_NUM_BYTES;
        ...
        aborts_if scheme == MULTI_ED25519_SCHEME && (
            len(public_key_bytes) / multi_ed25519::INDIVIDUAL_PUBLIC_KEY_NUM_BYTES > multi_ed25519::MAX_NUMBER_OF_PUBLIC_KEYS
            || len(public_key_bytes) % multi_ed25519::INDIVIDUAL_PUBLIC_KEY_NUM_BYTES != multi_ed25519::THRESHOLD_SIZE_BYTES
        );
        aborts_if scheme == MULTI_ED25519_SCHEME &&
            len(signature) % multi_ed25519::INDIVIDUAL_SIGNATURE_NUM_BYTES != multi_ed25519::BITMAP_NUM_OF_BYTES;
    ...
    spec offer_signer_capability(
        ...
        aborts_if account_scheme == ED25519_SCHEME && len(account_public_key_bytes) != ed25519::PUBLIC_KEY_NUM_BYTES;
        aborts_if account_scheme == ED25519_SCHEME && account_resource.authentication_key != ed25519::spec_public_key_bytes_to_authentication_key(account_public_key_bytes);
        aborts_if account_scheme == ED25519_SCHEME && len(signer_capability_sig_bytes) != ed25519::SIGNATURE_NUM_BYTES;
        ...
        aborts_if account_scheme == MULTI_ED25519_SCHEME && (
            len(account_public_key_bytes) / multi_ed25519::INDIVIDUAL_PUBLIC_KEY_NUM_BYTES > multi_ed25519::MAX_NUMBER_OF_PUBLIC_KEYS
                || len(account_public_key_bytes) % multi_ed25519::INDIVIDUAL_PUBLIC_KEY_NUM_BYTES != multi_ed25519::THRESHOLD_SIZE_BYTES
        );
        aborts_if account_scheme == MULTI_ED25519_SCHEME && account_resource.authentication_key != multi_ed25519::spec_public_key_bytes_to_authentication_key(account_public_key_bytes);
        aborts_if account_scheme == MULTI_ED25519_SCHEME &&
            len(signer_capability_sig_bytes) % multi_ed25519::INDIVIDUAL_SIGNATURE_NUM_BYTES != multi_ed25519::BITMAP_NUM_OF_BYTES;
